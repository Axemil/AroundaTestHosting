...
class VelontoCase extends React.Component {
  componentDidMount() {
      ...
      <Fragment>
        ...
        <section className={s.sectionComment}>
          <div className={s.container}>
            <blockquote>
              <q>
                Arounda’s work and mindset represents the pinnacle of perfection
                while still being highly efficient and communicative
              </q>
              <div className={s.author}>
                ...
                <div className={s.name}>
                  ...
                  <span>
                    CEO at{" "}
                    <UnderlinedLink href="https://velonto.at/">
                      Velonto
                    </UnderlinedLink>
                  </span>
                </div>
          ...
          <div className={s.container}>
            ...
            <div className={s.item}>
              ...
              <p className={s.itemText}>
                Carry out small errands by bike any time you want. Make money from
                your hobby.
              </p>
            </div>
            <div className={s.item}>
              ...
              <p className={s.itemText}>
                Green transport as the main. Zero CO2 emissions and no negative
        ...
        <section className={s.sectionQuoteSecond}>
          <div className={s.container}>
            <div className={s.quoteWrapper}>
              ...
              Save and make money on small errands while keeping the environment
              clean
            </div>
          </div>
        </section>
            ...
            <div className={s.row}>
              ...
              <div className={s.item}>
                <div className={s.itemContent}>
                  ...
                  <p className={s.itemText}>
                    New branding elements and order-processing algorithms help
                    complete more orders for shorter periods of time.
                  </p>
                </div>
                <div className={s.itemNumber}>2</div>
              </div>
