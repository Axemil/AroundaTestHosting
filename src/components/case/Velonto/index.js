    ...
    <Fragment>
        ...
        <div className={s.container}>
          <div className={s.contentWrapper}>
            <div className={s.titleWrapper}>
              <TitleH size="hero">Food you love, delivered to you by Velonto</TitleH>
            </div>
      ...
      <section className={s.sectionComment}>
        <div className={s.container}>
          <blockquote>
            <q>
              Arounda’s work and mindset represents the pinnacle of perfection while
              still being highly efficient and communicative
            </q>
            <div className={s.author}>
              ...
              <div className={s.name}>
                ...
                <span>
                  CEO at{" "}
                  <UnderlinedLink href="https://velonto.at/">Velonto</UnderlinedLink>
                </span>
              </div>
            </div>
          </blockquote>
        ...
        <div className={s.container}>
          ...
          <div className={s.row}>
            <div className={s.item}>
              <div className={s.itemTitle}>Clients</div>
            ...
            <div className={s.item}>
              <div className={s.itemTitle}>Riders</div>
              <div className={s.itemList}>
                <ul>
            ...
            <div className={s.item}>
              <div className={s.itemTitle}>Partners</div>
              <div className={s.itemList}>
                <ul>
                  <li>More clients</li>
      ...
      <section className={s.sectionMobile}>
        <div className={s.contentWrapper}>
          ...
          <Description
            light
            text={
              "Our goal was to show through colors and a visual appearance that Velonto is a reliable assistant when it comes to small everyday tasks. We came up with a unique brand identity and made sure it is consistent in every medium, both mentally and visually. Spacious blue color, clean and uncluttered UI reveal calm, trust, freedom, and harmony."
            }
          />
        </div>
        <div className={`${s.image} ${s.image1}`}>
          <img
            src={"/assets/images/velonto/velontoBranding1.jpg"}
            alt={"velonto image"}
          />
        </div>
        <div className={`${s.image} ${s.image4}`}>
          <img
            src={"/assets/images/velonto/velontoBranding2.jpg"}
            alt={"velonto image"}
          />
        </div>
        <div className={`${s.image} ${s.image2}`}>
          <img
            src={"/assets/images/velonto/velontoBranding3.jpg"}
            alt={"velonto image"}
          />
        </div>
        <div className={`${s.image} ${s.image3}`}>
          <img
            src={"/assets/images/velonto/velontoBranding4.jpg"}
            alt={"velonto image"}
          />
        </div>
      </section>
      <section className={s.sectionMobileApp}>
        ...
        <div className={`${s.image} ${s.image1}`}>
          <img
            src={"/assets/images/velonto/velontoMobile4.jpg"}
            alt={"velonto image"}
          />
        </div>
        <div className={`${s.image} ${s.image2}`}>
          <img
            src={"/assets/images/velonto/velontoMobile2.jpg"}
            alt={"velonto image"}
          />
        </div>
        <div className={`${s.image} ${s.image3}`}>
          <img
            src={"/assets/images/velonto/velontoMobile3.jpg"}
            alt={"velonto image"}
          />
        </div>
      </section>
      <section className={s.sectionWebApp}>
        ...
        <div className={`${s.image} ${s.image1}`}>
          <img
            src={"/assets/images/velonto/velonto_slider1.jpg"}
            alt={"velonto image"}
          />
        </div>
        <div className={`${s.image} ${s.image2}`}>
          <img
            src={"/assets/images/velonto/velonto_slider2.jpg"}
            alt={"velonto image"}
          />
        </div>
      ...
      <section className={s.sectionLanding}>
        <div className={s.imageWrapper}>
          <img
            src="/assets/images/velonto/velonto_landing.jpg"
            alt="velonto landing"
          />
        </div>
        <div className={s.contentWrapper}>
      ...
      <section className={s.sectionHelped}>
        <div className={s.container}>
          ...
          <div className={s.item}>
            ...
            <div className={s.itemTitle}>A unique value proposition</div>
            <p className={s.itemText}>
              Carry out small errands by bike any time you want. Make money from your
              hobby.
            </p>
          </div>
          <div className={s.item}>
            <div className={s.itemNumber}>2</div>
            <div className={s.itemTitle}>Ecological sustainability</div>
            <p className={s.itemText}>
              Green transport as the main. Zero CO2 emissions and no negative impact
              on the environment.
            </p>
          </div>
          <div className={s.item}>
            <div className={s.itemNumber}>3</div>
            <div className={s.itemTitle}>Experience accumulation</div>
            <p className={s.itemText}>
              Fast, responsive and user-oriented service delivers better UX and
              generates a higher number of orders.
            </p>
          </div>
          <div className={s.item}>
            <div className={s.itemNumber}>4</div>
            <div className={s.itemTitle}>Landing pages</div>
            <p className={s.itemText}>
              Increase conversion rates via relevant messages to the users, ensure
              high customer satisfaction.
            </p>
          </div>
          <div className={s.item}>
            <div className={s.itemNumber}>5</div>
            <div className={s.itemTitle}>Marketing websites</div>
            <p className={s.itemText}>
              Engage audiences with beautiful designs and convert users into
              returning customers.
            </p>
          </div>
          <div className={s.item}>
          ...
          <div className={s.row}>
            <div className={s.item}>
              <div className={s.itemContent}>
                <div className={s.itemTitle}>Save time</div>
                <p className={s.itemText}>
                  Clients can fully trust their errands to a well-trained net of
            ...
            <div className={s.item}>
              <div className={s.itemContent}>
                <div className={s.itemTitle}>Be more effective</div>
                <p className={s.itemText}>
                  New branding elements and order-processing algorithms help complete
                  more orders for shorter periods of time.
                </p>
              </div>
              <div className={s.itemNumber}>2</div>
            </div>
            <div className={s.item}>
              <div className={s.itemContent}>
                <div className={s.itemTitle}>Earn money</div>
                <p className={s.itemText}>
                  The good and flexible interface encourages users to place more
                  orders, increase customer retention, thus giving more profit
                  opportunities for bike riders and local businesses.
                </p>
              </div>
              <div className={s.itemNumber}>3</div>
            </div>
          ...
          <div className={s.contentWrapper}>
            ...
            <div className={s.list}>
              <div className={s.item}>
                ...
                <div className={s.itemNumber}>Foodninjas</div>
              </div>
              <div className={s.item}>
                <div className={s.itemLabel}>Location</div>
              ...
              <div className={s.item}>
                ...
                <div className={s.itemNumber}>10 000+</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className={s.sectionScope}>
        <div className={s.container}>
          ...
          <div className={s.row}>
            ...
            <div className={s.item}>
              <div className={s.itemTitle}>Development</div>
              <ul className={s.list}>
            ...
            <div className={s.item}>
              ...
              <ul className={s.list}>
                <li>
                  <UnderlinedLink href="https://velonto.at/">Website</UnderlinedLink>
                </li>
                <li>
                  <UnderlinedLink href="https://liefern.velonto.at/">
                    Web Application
                  </UnderlinedLink>
                </li>
                <li>
                  <UnderlinedLink href="https://apps.apple.com/at/app/velonto-essen/id1479326595">
                    iOS Application
                  </UnderlinedLink>
                </li>
              </ul>
