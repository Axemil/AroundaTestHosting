            ...
            <Fragment>
                        ...
                        <blockquote>
                            ...
                            <div className={s.author}>
                                ...
                                <div className={s.name}>
                                    El Asmar
                                <div>Founder at <UnderlinedLink href={'https://gigzi.com/'}><a target="_blank">Gigzi</a></UnderlinedLink></div>
                                </div>
                            </div>
                        </blockquote>
                    </div>
                ...
                <section className={s.sectionMobileApp}>
                    ...
                    <div className={`${s.image} ${s.image6}`}>
                        <img src={'/assets/images/gigzi/gigzi_slider2.jpg'} alt={'gigzi image'} />
                    </div>
