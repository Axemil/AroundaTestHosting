      ...
      <Fragment>
          ...
          <div className={s.container}>
            <div className={s.contentWrapper}>
              <div className={s.titleWrapper}>
                <TitleH size="hero">Move mountains, move waves</TitleH>
              </div>
              <div className={s.descWrapper}>
                <Description
                  text={
                    "What was first a small design tweak request turned into a complete makeover of an existing app, leading us to replace poor usability and a crude UI with a fresh interface and intelligent app-flow. We took Bold from a UX audit and niche analysis to complex product development and go-to-market strategy."
                  }
                />
              </div>
            </div>
            ...
            <ul className={s.list}>
              <li>
                ...
                <Description
                  light
                  text={
                    "Bold is an application that helps users “get bold” with the help of meditation and pep talks. Being bold means understanding yourself and fighting against negative thoughts. It brings out your inner strength and makes you more confident mentally and emotionally. The iOS app was made to help people relax with amazing videos, masterclasses, and calming music."
                  }
                />
              </li>
              <li>
        ...
        <section className={s.sectionComment}>
          <div className={s.container}>
            <blockquote>
              <q>
                These guys from Arounda are really awesome! <br /> My advice - don’t
                think, hire them
              </q>
              <div className={s.author}>
                <div className={s.image}>
                  <LazyLoadImage
                    src="/assets/images/bold/bold_avatar.jpg"
                    alt="Mikhail Nikonorov"
                  />
                </div>
                <div className={s.name}>
                  ...
                  <div>
                    Founder & CEO at{" "}
                    <UnderlinedLink href="https://thebold.app/">Bold</UnderlinedLink>
                  </div>
                </div>
              </div>
            </blockquote>
          ...
          <div className={s.container}>
            ...
            <div className={s.row}>
              <div className={s.item}>
                ...
                <div className={s.itemTitle}>Mobile app</div>
              ...
              <div className={s.item}>
                ...
                <div className={s.itemTitle}>Landing page</div>
                <div className={s.itemList}>
                  <ul>
                    <li>Easy usability for users of all age groups</li>
                    <li>
              ...
              <div className={s.item}>
                ...
                <div className={s.itemTitle}>Go-to-market</div>
                <div className={s.itemList}>
                  <ul>
                    <li>
        ...
        <section className={s.sectionMobile}>
          ...
          <div className={`${s.image} ${s.image1}`}>
            <LazyLoadImage
              src={"/assets/images/bold/boldMobile-1.jpg"}
              alt={"velonto image"}
            />
          </div>
          <div className={`${s.image} ${s.image2}`}>
            <LazyLoadImage
              src={"/assets/images/bold/boldMobile-3.jpg"}
              alt={"velonto image"}
            />
          </div>
          <div className={`${s.image} ${s.image3}`}>
            <LazyLoadImage
              src={"/assets/images/bold/boldMobile-2.jpg"}
              alt={"velonto image"}
            />
          </div>
        </section>
        <section className={s.sectionLanding}>
          ...
          <div className={s.imageWrapper}>
            <LazyLoadImage
              src="/assets/images/bold/bold_landing.jpg"
              alt="bold landing"
            />
          </div>
        </section>
        <section className={s.sectionHelped}>
          <div className={s.container}>
            ...
            <div className={s.item}>
              ...
              <div className={s.itemTitle}>Identifying the Problems</div>
              <p className={s.itemText}>
                Our team identified the missing screens while doing the UX audit of
                the existing app. As a result, we came up with a new interface, thus
                the app was rebuilt from scratch.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>2</div>
              <div className={s.itemTitle}>New Identity</div>
              <p className={s.itemText}>
                The close cooperation with the client led to several important
                changes from creating a new brand logo to new fonts and color
                palette. We made sure all screens were consistent in terms of design
                and go along with the brand's main mission.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>3</div>
              <div className={s.itemTitle}>iOS app development</div>
              <p className={s.itemText}>
                Our team created an innovative and vibrant content package for the
                iOS app. The easy design of the new landing page helped the app to
                get more leads and aim for higher revenue.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>4</div>
              <div className={s.itemTitle}>Practical Indulgence</div>
              <p className={s.itemText}>
                A thorough analysis of existing competitors was made to understand
                the needs and requirements of the market. We wanted to understand how
                the Bold app could help users practically. We engaged ourselves and
                real users in meditation process to get to the core of the client’s
                idea.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>5</div>
              <div className={s.itemTitle}>Marketing Strategy</div>
              <p className={s.itemText}>
                We spared no efforts in developing a marketing strategy. Bold got a
                complete integration with all the most important social networks,
                including charity organizations in particular. Brainstorms, open
                timing, and a time & material approach (T&M) helped us to get the
            ...
            <div className={s.item}>
              <a
                target="_blank"
                href="https://apps.apple.com/be/app/bold-strong-smart-mind/id1491187912"
              >
                <div className={s.itemIcon}>
        ...
        <section className={s.sectionQuoteSecond}>
          <div className={s.container}>
            <div className={s.quoteWrapper}>
              ...
              Bold app is a tool to refine your physical, mental, emotional, and
              spiritual parts until they emerge as one!
            </div>
          </div>
        </section>
            ...
            <div className={s.row}>
              <div className={s.item}>
                <div className={s.itemContent}>
                  ...
                  <p className={s.itemText}>
                    We offered new solutions so users can upgrade the status of their
                    mental health in real time by using the Bold app. Being bold
                    means to discover your own power and change the way you see
                    yourself.
                  </p>
                </div>
                <div className={s.itemNumber}>1</div>
              ...
              <div className={s.item}>
                <div className={s.itemContent}>
                  <div className={s.itemTitle}>Land Your Revenues</div>
                  <p className={s.itemText}>
                    A landing page is a perfect place to promote your app and boost
                    your revenue stream. The innovative design of a landing page
                    communicates your app's ease of use and interactiveness.
                  </p>
                </div>
                <div className={s.itemNumber}>2</div>
              </div>
              <div className={s.item}>
                <div className={s.itemContent}>
                  <div className={s.itemTitle}>Wise Marketing</div>
                  <p className={s.itemText}>
                    Marketing was the key to the success of this meditation app. With
                    that in mind, a full-fledged marketing strategy was created and
            ...
            <div className={s.contentWrapper}>
              ...
              <div className={s.list}>
                <div className={s.item}>
                  ...
                  <div className={s.itemNumber}>2+ years</div>
                </div>
                <div className={s.item}>
                  <div className={s.itemLabel}>Platform</div>
                  <div className={s.itemNumber}>iOS App</div>
                </div>
                <div className={s.item}>
                  <div className={s.itemLabel}>Users</div>
                  <div className={s.itemNumber}>1 000+</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={s.container}>
            ...
            <div className={s.row}>
              ...
              <div className={s.item}>
                ...
                <ul className={s.list}>
                  <li>
                    <UnderlinedLink href="https://thebold.app/">
                      Landing page
                    </UnderlinedLink>
                  </li>
                  <li>
                    <UnderlinedLink href="https://apps.apple.com/be/app/bold-strong-smart-mind/id1491187912">
                      iOS Application
                    </UnderlinedLink>
                  </li>
                </ul>
