    ...
    return (
      <Fragment>
          ...
          <div className={s.container}>
            <div className={s.contentWrapper}>
              <div className={s.titleWrapper}>
                <TitleH size="hero">Your Cloud Efficiency Expert</TitleH>
              </div>
        ...
        <section className={s.sectionWhat}>
          ...
          <div className={s.linkWrapper}>
            <a target="_blank" href="https://www.metricly.com/">
        ...
        <section className={s.sectionComment}>
          <div className={s.container}>
            <blockquote>
              <q>
                Everything Arounda has produced, from design to code, has been
                enterprise-grade quality they are fantastic to work with!
              </q>
              <div className={s.author}>
                <div className={s.image}>
                  <img src="/assets/images/metricly/img.jpg" alt="Trent Waskey" />
                </div>
                <div className={s.name}>
                  Trent Waskey
                  <div>
                    Founder at{" "}
                    <UnderlinedLink href="https://www.metricly.com/">
                      Metricly
                    </UnderlinedLink>
                  </div>
                </div>
          ...
          <div className={s.container}>
            ...
            <div className={s.row}>
              ...
              <div className={s.item}>
                ...
                <div className={s.itemTitle}>Blog</div>
                <div className={s.itemList}>
                  <ul>
              ...
              <div className={s.item}>
                ...
                <div className={s.itemTitle}>Documentation tool</div>
                <div className={s.itemList}>
                  <ul>
        ...
        <section className={s.sectionMobile}>
          <div className={s.contentWrapper}>
            ...
            <Description
              light
              text={
                "Our team reinvented the blog section for Metricly. With its new design approach, the blog does a great job of keeping its users updated about all the AWS cost management practices and Metricly product features. It has a brilliant design that portrays the technical details with engaging UI graphics. Increased conversion rates and higher turnovers are the results of this simple yet catchy blog redesign."
              }
            />
          </div>
          <div className={`${s.image} ${s.image1}`}>
            <img
              src={"/assets/images/metricly/metricly_mobile1.jpg"}
              alt={"metricly image"}
            />
          </div>
          <div className={`${s.image} ${s.image2}`}>
            <img
              src={"/assets/images/metricly/metricly_mobile2.jpg"}
              alt={"metricly image"}
            />
          </div>
          <div className={`${s.image} ${s.image3}`}>
            <img
              src={"/assets/images/metricly/metricly_mobile3.jpg"}
              alt={"metricly image"}
            />
          </div>
        </section>
        <section className={s.sectionLanding}>
          ...
          <div className={s.imageWrapper}>
            <img
              src="/assets/images/metricly/metricly_landing.jpg"
              alt="metricly landing"
            />
          </div>
        </section>
        <section className={s.sectionMobileApp}>
          ...
          <div className={`${s.image} ${s.image5}`}>
            <img
              src={"/assets/images/metricly/metricly_slider1.jpg"}
              alt={"metricly image"}
            />
          </div>
          <div className={`${s.image} ${s.image6}`}>
            <img
              src={"/assets/images/metricly/metricly_slider2.jpg"}
              alt={"metricly image"}
            />
          </div>
        ...
        <section className={s.sectionHelped}>
          <div className={s.container}>
            ...
            <div className={s.item}>
              ...
              <div className={s.itemTitle}>Step-by-step Solutions</div>
              <p className={s.itemText}>
                We research the technology and got a deep understanding of all
                technical components we had to work with.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>2</div>
              <div className={s.itemTitle}>Integrated Design</div>
              <p className={s.itemText}>
                With the full involvement in the process, we created a great UX/UI
                for our client’s target audience — DevOps specialists.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>3</div>
              <div className={s.itemTitle}>Email Marketing</div>
              <p className={s.itemText}>
                Our team updated templates for email newsletters which also added to
                the increase of turnovers and gross revenue.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>4</div>
              <div className={s.itemTitle}>Data Sorting System</div>
              <p className={s.itemText}>
                This platform required a strong UX design that could support the load
                of the data and sort it at the same time.
              </p>
            </div>
            <div className={s.item}>
              <div className={s.itemNumber}>5</div>
              <div className={s.itemTitle}>Marketing Systems</div>
              <p className={s.itemText}>
                After our deep research, we created efficient marketing materials for
                SaaS platforms. The blog and new email templates started to catch
        ...
        <section className={s.sectionQuoteSecond}>
          <div className={s.container}>
            <div className={s.quoteWrapper}>
              ...
              Metricly’s vision is to have a financial system that enables users
              worldwide
            </div>
          </div>
        </section>
            ...
            <div className={s.row}>
              <div className={s.item}>
                <div className={s.itemContent}>
                  <div className={s.itemTitle}>Data Sorting Systems</div>
                  <p className={s.itemText}>
                    The most complex solution we worked on was the data sorting
                    system. It gives users all the information based on accurate
              ...
              <div className={s.item}>
                <div className={s.itemContent}>
                  <div className={s.itemTitle}>Cloud Computing</div>
                  <p className={s.itemText}>
                    AWS cost optimization is an important part of the sales and we
                    wanted to keep up by providing great design solutions to help
              ...
              <div className={s.item}>
                <div className={s.itemContent}>
                  <div className={s.itemTitle}>Marketing is the Key</div>
                  <p className={s.itemText}>
                    You need a proper marketing strategy to reach the necessary
                    amount of people. We created strong marketing materials for SaaS
                    platforms, email newsletters, and blog section to make this
                    project a success.
                  </p>
                </div>
                <div className={s.itemNumber}>3</div>
          ...
          <div className={s.container}>
            ...
            <div className={s.contentWrapper}>
              ...
              <div className={s.list}>
                <div className={s.item}>
                  <div className={s.itemLabel}>Acquired by</div>
                  <div className={s.itemNumber}>Virtana</div>
                </div>
                <div className={s.item}>
                  <div className={s.itemLabel}>Funding Amount</div>
                  <div className={s.itemNumber}>$11M+</div>
                </div>
                <div className={s.item}>
        ...
        <section className={s.sectionScope}>
          <div className={s.container}>
            ...
            <div className={s.row}>
              ...
              <div className={s.item}>
                <div className={s.itemTitle}>UX/UI design</div>
                <ul className={s.list}>
                  <li>UX research</li>
                  <li>App flow</li>
                  <li>Wireframes</li>
              ...
              <div className={s.item}>
                ...
                <ul className={s.list}>
                  ...
                  <li>
                    <UnderlinedLink href="https://tools.metricly.com/?utm_source=www">
                      AWS Tool Web Application
                    </UnderlinedLink>
                  </li>
                </ul>
